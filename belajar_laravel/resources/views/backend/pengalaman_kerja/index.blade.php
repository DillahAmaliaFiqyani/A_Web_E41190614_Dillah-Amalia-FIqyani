...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="icon-document-alt"></li>Riwayat Hidup</h3>
                <ol class="breadcrumb">
                    ...
                    <table class="table table-striped table-advance table-hover">
                        <tbody>
                            <tr>
                                ...
                                <th><i class="icon-document"></i> Jabatan</th>
                                <th><i class="icon-calender"></i> Tahun Masuk</th>
                                <th><i class="icon-calender"></i> Tahun Keluar</th>
